...
class PaviaURaw(DataReader):
    def __init__(self):
        ...
        raw_data_package = sio.loadmat(r"./Datasets/Indian_pines_corrected.mat")
        self.data_cube = raw_data_package["paviaU"].astype(np.float32)
        truth = sio.loadmat(r"WFCG-master/Datasets/Indian_pines_gt.mat")
...
class IndianRaw(DataReader):
    def __init__(self):
        ...
        truth = sio.loadmat(r"./Datasets/Indian_pines_gt.mat")
        self.g_truth = truth["groundT"].astype(np.float32)
