...
from .attentions import SpectralTransformer, ChannelAttention
import torch
...
class SegNet_v2(nn.Module):
    def __init__(self,
        ...
        self.transformer = SpectralTransformer(int(in_channels * scale_layer), block_num, class_num)
    ...
    def forward(self, x: torch.Tensor, index: torch.Tensor):
        ...
        finall = self.transformer(torch.cat(features, dim=1), index)
